  ...
  return (
    <footer className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8">
      ...
      <div
        ...
        <div
          className="absolute right-1/4 -bottom-24 h-80 w-80 rounded-full bg-rose-600/20 blur-3xl"></div>
      </div>
      <div
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <p
            className="text-foreground mb-6 max-w-xs text-center text-sm md:text-left">
            PriceHunter is a web application that helps you compare prices from thousands of stores and save money on every purchase.
          </p>
          <div className="mt-2 flex gap-3 text-rose-400">
            ...
            <a href="https://github.com/Tarun553" aria-label="GitHub" className="hover:text-foreground transition">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path
        ...
        <nav
          ...
          <div>
            <div
              className="mb-3 text-xs font-semibold tracking-widest text-rose-400 uppercase">
              PriceHunter
            </div>
      ...
      <div className="text-foreground relative z-10 mt-10 text-center text-xs">
        <span>&copy; 2025 PriceHunter. All rights reserved.</span>
      </div>
    </footer>
  );
}
